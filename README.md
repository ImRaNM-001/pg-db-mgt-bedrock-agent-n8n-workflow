...
<p align="center">
  <img src="screenshots/download (3)" alt="Project Logo" width="500"/>
</p>


6. In the AWS Console search bar, type **RDS**. Select Aurora and RDS from the results.
<p align="center">
  <img src="screenshots/download (4)" alt="Project Logo" width="500"/>
</p>

7. Click on **Databases** from the left navigation menu and then click **Create database**.
<p align="center">
  <img src="screenshots/download (5)" alt="Project Logo" width="500"/>
</p>
...
8. In the Create Database section, specify the following details,
    ...
    <p align="center">
    <img src="screenshots/download (6)" alt="Project Logo" width="500"/>
    </p>
    ...
    <p align="center">
    <img src="screenshots/download (7)" alt="Project Logo" width="500"/>
    </p>
    ...
    <p align="center">
    <img src="screenshots/download (8)" alt="Project Logo" width="500"/>
    </p>
...
9. DB instance class : Select Burstable classes (includes t classes) - db.t3.micro - 2 vCPUs, 1 GiB RAM
    <p align="center">
    <img src="screenshots/download (9)" alt="Project Logo" width="500"/>
    </p>
    ...
    <p align="center">
    <img src="screenshots/download (10)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
    <img src="screenshots/download (11)" alt="Project Logo" width="500"/>
    </p>
...
9. Scroll down to **Additional Configuratio**n options at last, Expand it,
    ...
    <p align="center">
    <img src="screenshots/download (12)" alt="Project Logo" width="500"/>
    </p>
    ...
    <p align="center">
    <img src="screenshots/download (13)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
<img src="screenshots/download (14)" alt="Project Logo" width="500"/>
</p>
...
<p align="center">
<img src="screenshots/download (15)" alt="Project Logo" width="500"/>
</p>


4. Name: Enter **Ec-n8n-Server**
<p align="center">
<img src="screenshots/download (16)" alt="Project Logo" width="500"/>
</p>


5. Select **Amazon Linux 2023 AMI** from the dropdown.
<p align="center">
<img src="screenshots/download (17)" alt="Project Logo" width="500"/>
</p>
...
<p align="center">
<img src="screenshots/download (18)" alt="Project Logo" width="500"/>
</p>
...
7. AWS key pair is a secure pair of keys used for login and access to EC2 instances. It includes a public key placed on the instance and a private key kept on the user's local computer, used for authentication to prevent unauthorized access.
    ...
    <p align="center">
    <img src="screenshots/download (19)" alt="Project Logo" width="500"/>
    </p>
...
8. In Network Settings, Click on **Edit** Button:
    ...
    <p align="center">
    <img src="screenshots/download (20)" alt="Project Logo" width="500"/>
    </p>
...
1. Now, Click on the Instance, Click on **Connect**.
    <p align="center">
    <img src="screenshots/download (21)" alt="Project Logo" width="500"/>
    </p>

2. In the EC2 Instance Connect, Click on **Connect** button at the bottom
    <p align="center">
    <img src="screenshots/download (22)" alt="Project Logo" width="500"/>
    </p>
...
```
<p align="center">
    <img src="screenshots/download (23)" alt="Project Logo" width="500"/>
    </p>
...
```
<p align="center">
    <img src="screenshots/download (24)" alt="Project Logo" width="500"/>
    </p>
...
```
<p align="center">
    <img src="screenshots/download (25)" alt="Project Logo" width="500"/>
    </p>
...
```
<p align="center">
    <img src="screenshots/download (26)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
    <img src="screenshots/download (27)" alt="Project Logo" width="500"/>
    </p>

2. Click **Get Started**
<p align="center">
    <img src="screenshots/download (28)" alt="Project Logo" width="500"/>
    </p>

3. In the **Get paid features for free (forever)** prompt, click **Skip**.
<p align="center">
    <img src="screenshots/download (29)" alt="Project Logo" width="500"/>
    </p>

4. Click **Start** from **Scratch** option.
<p align="center">
    <img src="screenshots/download (30)" alt="Project Logo" width="500"/>
    </p>

5. Click the **plus icon** on the right side, then type **Chat Trigger** and select it. Press **Esc** key.
<p align="center">
    <img src="screenshots/download (31)" alt="Project Logo" width="500"/>
    </p>
<p align="center">
    <img src="screenshots/download (32)" alt="Project Logo" width="500"/>
    </p>

6. Next, click the **plus icon**, type **AI Agent** and select it to add the AI Agent node.
<p align="center">
    <img src="screenshots/download (33)" alt="Project Logo" width="500"/>
    </p>

7. In the AI Agent node options section, click **Add Option** and choose **System Message**.
<p align="center">
    <img src="screenshots/download (34)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
    <img src="screenshots/download (41)" alt="Project Logo" width="500"/>
    </p>

15. In the Credentials to connect field, click **Create New Credentials**.
<p align="center">
    <img src="screenshots/download (42)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
    <img src="screenshots/download (43)" alt="Project Logo" width="500"/>
    </p>

17. Click **Save** button.
<p align="center">
    <img src="screenshots/download (44)" alt="Project Logo" width="500"/>
    </p>
...
```
<p align="center">
    <img src="screenshots/download (45)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
    <img src="screenshots/download (46)" alt="Project Logo" width="500"/>
    </p>
...
<p align="center">
    <img src="screenshots/download (47)" alt="Project Logo" width="500"/>
    </p>
